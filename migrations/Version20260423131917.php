 ...
 */
final class Version20260423131917 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE client (id UUID NOT NULL, name VARCHAR(120) NOT NULL, is_active BOOLEAN NOT NULL, sector_id VARCHAR NOT NULL, PRIMARY KEY (id))');
        ...
        $this->addSql('CREATE TABLE sector (id VARCHAR(255) NOT NULL, name VARCHAR(100) NOT NULL, PRIMARY KEY (id))');
